...
kube_fn = 'solve-extract-deployment.yaml'


def main(container_name='gcr.io/panoptes-survey/solve-extract', timeout=1500):
...
if __name__ == '__main__':
    print("Docker GCE instance to plate-solve FITS images and perform source extraction and catalog matching.")
    main()
