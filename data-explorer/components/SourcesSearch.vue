  ...
  <v-container>
    <v-dialog v-model="modalActive" width="500">
      ...
      <v-card>
        ...
        <v-card-text>
          <v-form ref="form" v-model="searchModel.valid" lazy-validation>
            <v-row>
              <v-col>
                <v-text-field
                ...
                >
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="primary"
                      @click="$refs.menu.save(searchModel.startDate)"
                    >
                      OK
                    </v-btn>
                  </v-date-picker>
                ...
                >
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="primary"
                      @click="$refs.menu.save(searchModel.endDate)"
                    >
                      OK
                    </v-btn>
                  </v-date-picker>
...
export default {
  ...
  components: {},
  computed: {
    ...mapState(['units', 'searchModel', 'isSearching', 'fromSearch']),
    searchLabel: function() {
      if (this.fromSearch) {
        let label =
          'RA= ' + this.searchModel.ra + '° Dec= ' + this.searchModel.dec + '°'
